...
class Fusionnet_gn_model(BackendModel):
    ...
    def __init__(self, model_fn, gpuid):
       ...
       # self.opts = json.load(open("/mnt/blobfuse/train-output/conditioning/models/backup_conditional_superres512/training/params.json", "r"))["model_opts"]
        self.opts = json.load(
            open("/mnt/blobfuse/train-output/conditioning/models/backup_fusionnet32_gn_8_isotropic/training/params.json",
                 "r"))["model_opts"]
...
class Finetuned_unet_gn_model(BackendModel):
    ...
    def __init__(self, model_fn, gpuid):
        ...
        checkpoint = torch.load("/mnt/blobfuse/train-output/conditioning/models/backup_unet_gn_isotropic_nn8/training/checkpoint_best.pth.tar")
